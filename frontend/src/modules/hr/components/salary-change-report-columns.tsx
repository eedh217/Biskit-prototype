...
interface SalaryChangeReportColumnsProps {
  onDelete: (id: string) => void;
  onPreview: (id: string) => void;
  onRowClick: (report: SalaryChangeReport) => void;
  onResend: (id: string) => void;
}

export const createSalaryChangeReportColumns = ({
  onDelete,
  onPreview,
  onRowClick,
  onResend,
}: SalaryChangeReportColumnsProps): ColumnDef<SalaryChangeReport>[] => [
  {
